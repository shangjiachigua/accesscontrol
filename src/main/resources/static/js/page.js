...
var  page = {
     ...
     */
    "initWithUl":function(pageId,listCount,currentPage,fun){
        ...
        $("a#pageJumpA").unbind().on("click",function (e) {
            var pageJump = $("input#pageJumInput").val();
            if(pageJump && $.trim(pageJump) && /^[1-9][0-9]{0,}$/.test(pageJump)){
    ...
    "setPageListCount":function(pageId,listCount,currentPage,fun){
        ...
        page.initWithUl(pageId,listCount,currentPage,fun);
    ...
    "getPageListModel":function(pageCount,currentPage){
        ...
        appendStr+="<li><span>共"+pageCount+"页</span></li>";
        appendStr+="<li><span>到</span><span><input type='number' value='1' id='pageJumInput' /></span><span>页</span></li>";
        appendStr+="<li><a href='javascript:void(0)' class='blue block' id='pageJumpA'>跳转</a></li>";
